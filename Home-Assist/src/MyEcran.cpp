...
#include "MyEcran.h"
  ...
  void CEcran::setup(const String pref) {
    mPrefixNVS = pref;
...
void CEcran::forceWake() {
  ...
  digitalWrite(TFT_BL, HIGH);
  mbEcranAllume = true;
  mZoneStatus.drawStatus("Reveille par MQTT", false);
  delay(2000);
}
...
void CEcran::updateSleepTimeout(int32_t st) {
  ...
  mZoneStatus.drawStatus(s, false);
...
void CEcran::desactiveChaudiere(bool bDrawInterface/*=true*/) {
  ...
  mZoneStatus.drawStatus("Chaudiere desactivee", false);
}
void CEcran::activeChaudiere(bool activ/*=true*/, bool bDrawInterface/*=true*/){
  ...
  mZoneStatus.drawStatus("Chaudiere activee", false);
}
void CEcran::desactiveProjecteur(bool bDrawInterface/*=true*/) {
  drawMainInterface();
  mZoneStatus.drawStatus("Projecteur desactive", false);
}
void CEcran::activeProjecteur(bool activ/*=true*/, bool bDrawInterface/*=true*/){
  ...
  drawMainInterface();
  mZoneStatus.drawStatus("Projecteur active", false);
}
void CEcran::desactiveGuirlande(bool bDrawInterface/*=true*/) {
  drawMainInterface();
  mZoneStatus.drawStatus("Guirlande desactivee", false);
}
void CEcran::activeGuirlande(bool activ/*=true*/, bool bDrawInterface/*=true*/) {
  ...
  drawMainInterface();
  mZoneStatus.drawStatus("Guirlande activee", false);
}
void CEcran::desactiveChauffageSb(bool bDrawInterface/*=true*/) {
  drawMainInterface();
  mZoneStatus.drawStatus("Chauffage desactive", false);
}
void CEcran::activeChauffageSb(bool activ/*=true*/, bool bDrawInterface/*=true*/) {
  ...
  drawMainInterface();
  mZoneStatus.drawStatus("Chauffage active", false);
}
...
void CEcran::updateThermometreLocal() { 
  if (mucSerieAffichageEnCours != 1) return;
  String nom = "";
  float temp = 0.0;
  #ifdef __LOCAL_MODE__  
...
void CEcran::updateAllStates() {
  ...
  void CEcran::updateStatus(const String& msg, bool drawInterface/*=false*/, bool memorise/*=false*/) {
    ...
    mZoneStatus.drawStatus(msg, memorise);
  }  

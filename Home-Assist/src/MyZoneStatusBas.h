#ifndef __MY_ZONE_STATUS_BAS_H__
#define __MY_ZONE_STATUS_BAS_H__
...
class CZoneStatusBas {
    ...
    public:
        CZoneStatusBas(TFT_eSPI& tft, unsigned int x, unsigned int y, unsigned int w, unsigned int h, unsigned int bgcolor, String name="") : mTft(tft),
...
#endif // __MY_ZONE_STATUS_BAS_H__
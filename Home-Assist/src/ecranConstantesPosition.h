...
// === POSITION DE COULSDB EN SÉRIE 3 (à droite de ThCave, en haut) ===
#define SERIE3_COULSDB_X     (LOCAL_1_X + LOCAL_1_W + 2)
#define SERIE3_COULSDB_Y     BOUTON_PA_Y
#define SERIE3_COULSDB_W     DATE_HEURE_W
#define SERIE3_COULSDB_H     REMOTE_B_1_H
// Flotteur juste en dessous de CoulSdb
#define SERIE3_FLOTTEUR_X    SERIE3_COULSDB_X
#define SERIE3_FLOTTEUR_Y    (SERIE3_COULSDB_Y + SERIE3_COULSDB_H + 2)
#define SERIE3_FLOTTEUR_W    SERIE3_COULSDB_W
#define SERIE3_FLOTTEUR_H    SERIE3_COULSDB_H
// NAS en dessous du flotteur
#define SERIE3_NEWNAS_X      SERIE3_COULSDB_X
#define SERIE3_NEWNAS_Y      (SERIE3_FLOTTEUR_Y + SERIE3_FLOTTEUR_H + 2)
#define SERIE3_BIGNAS_X      SERIE3_COULSDB_X
#define SERIE3_BIGNAS_Y      (SERIE3_NEWNAS_Y + SERIE3_COULSDB_H + 2)
